...
| Descrição | _Eu como_ usuário _Desejo_ receber a moeda gamificada (Lingots) após completar minha tarefa diária _Para que eu como usuário possa me sinta mais satisfeito ao usar mais o aplicativo_  |
...
| Descrição | _Eu como_ usuário _Desejo_ receber a moeda gamificada (Lingots) após completar um módulo de tarefa  _Para que eu como usuário possa me sinta mais motivado ao usar o aplicativo e a aprender mais_  |
...
| Descrição | _Eu como_ usuário _Desejo_ receber a moeda gamificada (Lingots) após o final do período de uma liga terminando entre os três primeiros colocados  _Para que eu como usuário possa me sinta mais motivado ao usar o aplicativo e a aprender mais_  |
...
| Descrição | _Eu como_ usuário _Desejo_ comprar a skill por 10 Lingots para congelar danos cousados por tempo fora do app sem preaticar _Para que eu como usuário possa me sinta ainda em equidade para competir de forma gamificada com meus amigos e colegas_  |
| Críterios de Aceitação| Deve contém as seguintes opções: </br> > Tem que ter Lingots sufientes </br> >|

| **ID** | **Nome** |
|:-------|:---------|
| US47     | Compra de "Dobro ou nada" |
| Descrição | _Eu como_ usuário _Desejo_ comprar a skill por 5 Lingots para aumentar meus pontos xp _Para que eu como usuário possa me sinta mais motivado a continuar utilizando o app e ganhar pontos de experiência_  |
| Críterios de Aceitação| Deve contém as seguintes opções: </br> > Tem que ter Lingots suficientes </br> >|

| **ID** | **Nome** |
|:-------|:---------|
| US48     | Compra de Traje formal |
| Descrição | _Eu como_ usuário _Desejo_ comprar o traje formal por 20 Lingots para meu Duo ficar mais caracterizado _Para que eu como usuário possa sinta que o aplicativo está mais pessoal e traga mais motivação_  |
| Críterios de Aceitação| Deve contém as seguintes opções: </br> > Tem que ter Lingots suficientes </br> >|

| **ID** | **Nome** |
|:-------|:---------|
| US49     | Compra de Traje esportivo dourado |
| Descrição | _Eu como_ usuário _Desejo_ comprar o traje esportivo dourado por 30 Lingots para meu Duo ficar mais caracterizado _Para que o eu como usuário possa sinta que o aplicativo está mais pessoal e traga mais motivação_  |
| Críterios de Aceitação| Deve contém as seguintes opções: </br> > Tem que ter Lingots suficientes </br> >|

| **ID** | **Nome** |
|:-------|:---------|
| US50     | Compra de Traje super Duo |
| Descrição | _Eu como_ usuário _Desejo_ comprar o traje super Duo por 50 Lingots para meu Duo ficar mais caracterizado _Para que eu como usuário possa sinta que o aplicativo está mais pessoal e traga mais motivação_  |
| Críterios de Aceitação| Deve contém as seguintes opções: </br> > Tem que ter Lingots suficientes </br> >|
...
| Descrição | _Eu como_ desenvolvedor _Desejo_ dar a oportunidade do usuário testar a versão plus do aplicativo _Para que eu como desenvolvedor possa ver que tenho mais chance de usuários aderindo à versão paga do aplicativo_  |
...
| Descrição | _Eu como_ usuário _Desejo_ ter acesso à versão com exclusividades para ter melhor aproveito do aplicativo _Para que o eu como usuário possa me sinta mais satisfeito ao usar mais o aplicativo e a aprender de forma mais eficiente_  |
...
| Descrição | _Eu como_ desenvolvedor _Desejo_ mostrar ao meu usuário anúncios de propagandas _Para que o meu usuário possa ver que tenho motivos maiores para aderir a versão paga e eu posso desenvolvedor e empresa possa lucrar com propagandas_  |
