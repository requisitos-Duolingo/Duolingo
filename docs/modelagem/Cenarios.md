...
|**Episódios** |
|<p>Usuário novo na plataforma Duolingo</p> <p>Usuário que deseja aprender um idioma novo</p>|
|**Restrição** |
|Internet indisponível|
|**Exceção**   |
...
|<p>Conta no Duolingo</p> <p>Acesso a Internet</p> <p>Acesso a um Smartphone ou Computador</p>|
|**Episódios** |
|<p>Meta diária</p> <p>Usuário pode mudar a sua meta quando quiser</p> <p>Relax</p> <p>Regular</p> <p>Sério</p> <p>Insano</p> <p>Quantidade de experiências que o usuário pode realizar por dia</p> <p>O usuário ao estabelecer uma meta diária você se mantém motivado enquanto aprende um idioma</p>|
|**Restrição** |
|<p>Internet indisponível</p> <p>Não ser usuário do Duonligo</p>|
|**Exceção**   |
|<p>Sem acesso a Smartphone ou Computador</p> <p>Internet indisponível</p>|
...
|Convidar amigos|
|**Objetivo**  |
|Interação social na plataforma Duonligo|
|**Contexto**  |
...
|<p>Conta no Duolingo</p> <p>Acesso a Internet</p> <p>Acesso a um Smartphone ou Computador</p>|
|**Episódios** |
|<p>Acompanha a estática de apredizagem de seus amigos</p> <p>Usuário tem a oportunidade de se tornar Plus por  uma semana por cada amigo que é convidado e aceita instalar o app</p> <p>Usuário engajado em ganhar mais experiência</p>|
|**Restrição** |
|<p>Internet indisponível</p> <p>Não ser usuário do Duonligo</p>|
|**Exceção**   |
...
|**Episódios** |
|<p>Usuário padrão gasta as Ligots(moedas do Duolingo) para deixa-lo engajado</p>|
|**Restrição** |
|<p>Internet indisponível</p> <p>Não ser usuário do Duonligo</p>|
|**Exceção**   |
|<p>Sem acesso a Smartphone ou Computador</p> <p>Internet indisponível</p>|
